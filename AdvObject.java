 ...
 */
	public String getDescription() {
		return this.description; // Replace with your code
	}
 ...
 */
	public int getInitialLocation() {
		return this.location; // Replace with your code
	}
	...
	public static AdvObject readFromFile(Scanner scan) {
		...
		String description = "";
		int location = 0;
		while (scan.hasNextLine() && !(line = scan.nextLine()).trim().equals("") && !flag) {
			name = line;
			line = scan.nextLine();
			description = line;
			line = scan.nextLine();
		...
		return new AdvObject(name, description, location); // Replace with your code
	}
	...
	public String toString() {
		return "AdvObject [name=" + name + ", description=" + description + ", location=" + location + "]";
	}

	public AdvObject (String name, String description, int location){
		this.name = name;
